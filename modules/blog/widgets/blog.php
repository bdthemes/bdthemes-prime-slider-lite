...
namespace PrimeSliderPro\Modules\Blog\Widgets;
...
use PrimeSliderPro\Modules\Blog\Skins;
...
class Blog extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'button_text',
            [
                'label'       => esc_html__('Button Text', 'bdthemes-prime-slider') . BDTPS_PRO_PC,
        ...
        $this->add_control(
            'show_author',
            [
                'label'   => esc_html__('Show Author', 'bdthemes-prime-slider') . BDTPS_PRO_NC . BDTPS_PRO_PC,
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    '_skin!' => 'folio',
        ...
        $this->add_control(
            'show_admin_info',
            [
                'label'     => esc_html__('Show Author', 'bdthemes-prime-slider') . BDTPS_PRO_PC,
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    '_skin' => 'folio',
        ...
        $this->add_control(
            'show_date',
            [
                'label'   => esc_html__('Show Date', 'bdthemes-prime-slider') . BDTPS_PRO_NC . BDTPS_PRO_PC,
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'show_meta' => 'yes'
        ...
        $this->add_control(
            'show_comments',
            [
                'label'   => esc_html__('Show Comments', 'bdthemes-prime-slider') . BDTPS_PRO_NC . BDTPS_PRO_PC,
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'show_meta' => 'yes'
        ...
        $this->add_control(
            ...
            [
                'label'       => __('Select Posts', 'bdthemes-prime-slider') . BDTPS_PRO_NC,
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Background', 'bdthemes-prime-slider') . BDTPS_PRO_PC,
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'fields_options' => [
                    'background' => [
                        'label' => esc_html__('Background Type', 'bdthemes-prime-slider') . BDTPS_PRO_PC,
                    ],
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => esc_html__('Space Between', 'bdthemes-prime-slider') . BDTPS_PRO_NC,
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => __('Border Radius', 'bdthemes-prime-slider') . BDTPS_PRO_NC,
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors'  => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'    => esc_html__('Box Shadow', 'bdthemes-prime-slider') . BDTPS_PRO_NC,
                'selector' => '{{WRAPPER}} .bdt-prime-slider .bdt-ps-category a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Border Color', 'bdthemes-prime-slider') . BDTPS_PRO_NC,
                'type'      => Controls_Manager::COLOR,
                'condition' => [
        ...
        $this->add_responsive_control(
            'meta_icon_size',
            [
                'label'     => esc_html__('Size', 'bdthemes-prime-slider') . BDTPS_PRO_NC,
                'type'      => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Glassmorphism', 'bdthemes-element-pack') . BDTPS_PRO_NC . BDTPS_PRO_PC,
                'type'  => Controls_Manager::SWITCHER,
        ...
        $this->start_controls_section(
            ...
            [
                'label'      => __('Additional', 'bdthemes-prime-slider') . BDTPS_PRO_NC,
                'tab'        => Controls_Manager::TAB_STYLE,
                'condition' => [
                    '_skin' => 'folio',
                ],
